...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
 <!-- BREADCRUMBS SETCTION START -->
                            ...
                            <div class="new-customers">
                                <form action="#">
                                    ...
                                    <div class="login-account p-30 box-shadow">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <select class="custom-select">
                                                    ...
                                                    <option value="c-4">South Korea</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-6">
                                                <select class="custom-select">
                                                    <option value="defalt">City</option>
                                                    <option value="c-1">Melbourne</option>
                                                    <option value="c-2">Seoul</option>
                                        ...
                                        <input type="text"  placeholder="Specific Address here...">
        ...
        $("submit-btn-1 btn-hover-1").on("click",function(e){

        ...
        <div class="slider-area slider-2">
            <div class="bend niceties preview-2">
                <div id="nivoslider-2" class="slides">   
                    ...
                    <img src="/resources/img/slider/slider-2/slider-1.jpg" alt="" title="#slider-direction-4"  />
                    <img src="/resources/img/slider/slider-2/slider-1.jpg" alt="" title="#slider-direction-5"  />
                </div>
                <!-- ===== direction 1 ===== -->
                <div id="slider-direction-1" class="slider-direction">
                    ...
                    <div class="slider-content-1-image">
                        <div class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                            <div class="layer-1-1">
                                <img src="/resources/img/slider/slider-2/layer-1.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="slider-direction-2" class="slider-direction">
                    ...
                    <div class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="layer-1-1 layer-2-1">
                            <img src="/resources/img/slider/slider-2/layer-2.png" alt="" />
                        </div>
                    </div>
                </div>
                <!-- ===== direction 3 ===== -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="banner-item banner-2">
                                <div class="banner-img">
                                    <a href="#"><img src="/resources/img/banner/2.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="banner-item banner-3">
                                <div class="banner-img">
                                    <a href="#"><img src="/resources/img/banner/3.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 hidden-sm col-xs-12">
                            <div class="banner-item banner-4">
                                <div class="banner-img">
                                    <a href="#"><img src="/resources/img/banner/4.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="row active-featured-product slick-arrow-2">
                                ...
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="/resources/img/product-2/1.jpg" alt=""/>
                                        </a>
                                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="/resources/img/product-2/2.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="/resources/img/product-2/3.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-xs-12">
                                <div class="product-item product-item-2">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="/resources/img/product-2/4.jpg" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="up-comming-pro gray-bg up-comming-pro-2 clearfix">
                                <div class="up-comming-pro-img f-left">
                                    <a href="#">
                                        <img src="/resources/img/up-comming/2.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-4 hidden-sm col-xs-12">
                            <div class="banner-item banner-1">
                                ...
                                <div class="banner-img">
                                    <a href="#"><img src="/resources/img/banner/1.jpg" alt=""></a>
                                </div>
                                <div class="banner-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item product-item-2">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="/resources/img/product-2/5.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-item product-item-2">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="/resources/img/product-2/6.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                    ...
                                    <div class="col-md-3 hidden-sm col-xs-12">
                                        <div class="product-item product-item-2">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <img src="/resources/img/product-2/7.jpg" alt=""/>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
